...
void Sensor()
{
  ...
  String Impulse = String(count);
  Publish2MQTT(PubMQTT_Impulse, Impulse);  
 
  display.setFont(ArialMT_Plain_16);
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  display.drawString(0, 16, "Impulse:");
  display.setTextAlignment(TEXT_ALIGN_RIGHT);
  display.drawString(128, 16, Impulse);
