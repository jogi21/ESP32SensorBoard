...
char *PubMQTT_Ultraschall = "Ultraschall";
...
void Sensor()
{
  ...
  Ultraschall = String((float)uS / US_ROUNDTRIP_CM);
  
  Publish2MQTT(PubMQTT_Ultraschall, Ultraschall);  
  
  display.setFont(ArialMT_Plain_16);
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  display.drawString(0, 16, "Abstand:");
  display.setTextAlignment(TEXT_ALIGN_RIGHT);
  display.drawString(128, 16, Ultraschall);
