...
char *PubMQTT_IR1 = "IR1";
char *PubMQTT_IR2 = "IR2";
...
void Sensor()
{
  ...
  Publish2MQTT(PubMQTT_IR1, IR1);  
  Publish2MQTT(PubMQTT_IR2, IR2);  

  display.setFont(ArialMT_Plain_16);
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  display.drawString(0, 16, "IR 1:");
  display.setTextAlignment(TEXT_ALIGN_RIGHT);
  display.drawString(128, 16, IR1);

  display.setFont(ArialMT_Plain_16);
  display.setTextAlignment(TEXT_ALIGN_LEFT);
  display.drawString(0, 32, "IR 2:");
  display.setTextAlignment(TEXT_ALIGN_RIGHT);
  display.drawString(128, 32, IR2);
